...
class ShipToolTip extends StatelessWidget {
  ...
  const ShipToolTip({super.key, required this.parentContext});
      ...
      children: [
        ...
        Container(
          ...
          child: IconButton(
            ...
            icon: const Icon(Icons.arrow_back_outlined, size: 21),
          ),
        ),
        ...
        Container(
          ...
          child: IconButton(
            ...
            icon: const Icon(Icons.arrow_forward_outlined, size: 21),
          ),
        ),
      ],
    );
